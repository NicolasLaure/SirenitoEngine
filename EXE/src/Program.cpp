...
{
	camera = new FirstPersonController(Vector3(0, 0, 0), mainCamera);
	...
	background = new Sprite("res/textures/Background.jpg", Vector3(0, 0, 15.0f), Vector3(), -width, -height, rendererInstance);
	ground = new Sprite("res/textures/Background.jpg", Vector3(0, 0, 15.0f), Vector3(90.0f, 0, 0), -width, -height, rendererInstance);
}
