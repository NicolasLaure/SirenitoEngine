...
{
	rectangle = new Rectangle(glm::vec3(100.0f, 50.0f, 0.0f), 100.0f, 100.0f, rendererInstance);
	triangle = new Triangle(glm::vec3(300.0f, 120.0f, 0.0f), 200.0f, 125.0f, rendererInstance);
}
