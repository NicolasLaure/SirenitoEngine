...
Triangle::Triangle(glm::vec3 position, float width, float height, Color color, Renderer* renderer) : Shape(color, GetVertices(width, height), 21, GetIndices(), 3, renderer)
{
