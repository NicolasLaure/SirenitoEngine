...
SIRENITO_API class Sprite3D : public Entity2D
{
protected:
	float width;
	float height;
...
public:
	...
	SIRENITO_API Sprite3D(const char* texturePath, Vector3 position, Vector3 eulers, float width, float height, Color color, Renderer* rendererInstance);
	SIRENITO_API Sprite3D(const char* texturePath, Vector3 position, Vector3 eulers, float width, float height, Renderer* rendererInstance);
	SIRENITO_API Sprite3D(const char* texturePath, float width, float height, Color color, Renderer* rendererInstance);
	SIRENITO_API Sprite3D(const char* texturePath, float width, float height, Renderer* rendererInstance);
	SIRENITO_API ~Sprite3D();
